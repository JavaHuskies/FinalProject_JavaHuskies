...
/**
 * Work area panel for the Technology Lead role.
 * Displays open issues, pending deployments, and active work requests
 * scoped to the current user's organization.
 */
public class TechnologyLeadPanel extends JPanel {

    // ── Configuration ─────────────────────────────────────────────────────────
    private static final String requiredRole = Claims.roleTechnologyLead;
    private static final String pageTitle    = "Technology Lead Dashboard";
    private static final String pageSubtitle = "Technical Operations";
    ...
    /**
     * Constructs the Technology Lead work area panel.
     *
    ...
    private void buildComponents() {
        ...
        statsRow.add(buildStatCard("Open Issues",          "—"));
        statsRow.add(buildStatCard("Deployments Pending",  "—"));
        statsRow.add(buildStatCard("Active Work Requests", "—"));
    ...
    /**
     * Loads mock work request data into the table and updates stat cards.
